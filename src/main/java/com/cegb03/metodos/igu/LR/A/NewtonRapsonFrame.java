...
import com.cegb03.metodos.logica.LocRaices.Abiertos.NewtonRapsonCode;
 ...
 * @author cegb03
 */
public class NewtonRapsonFrame extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        NewtonRapsonCode nrc = new NewtonRapsonCode(a, tolerancia, funX, funY);
        if(txtAResultados.getText().isBlank())
            txtAResultados.setText(nrc.calcularRaiz());
        else
