package com.cegb03.metodos.LocRaices.Cerrados;
...
public class RegulaFalsiCode {
    ...
    public RegulaFalsiCode(double a, double b, double tol, String funX){
        this.a = a;
        this.b = b;
        this.tolerancia = tol;
        this.funX = funX;
    ...
    public String calcularRaiz(){
        if(fun(a)*fun(b)>0)
            return "No cumple condicion para operar";
        ...
        } while (error>tolerancia && cont < 150000);
